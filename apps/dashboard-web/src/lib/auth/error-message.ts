 ...
 * Spanish-only (`DASHBOARD_SOURCE_OF_TRUTH.md`, §10 "Textos
 * (`content/es/`)"), so known, stable Better Auth messages are translated here.
 *
 ...
 * yet is more honest than hiding it (§8.2 of the source of truth), even
